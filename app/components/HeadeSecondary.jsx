...
const capitalizeTitle = firstLetterCap + remainLetters
  ...
  return (
    <div className="text-white mb-10 xl:mb-24 h-[257px] md:h-[384px] xl:h-[447px] bg-[url('/images/bgbg-secondary.png')] bg-no-repeat bg-cover md:bg-bottom bg-center font-poppins w-full">
